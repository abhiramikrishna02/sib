...
const Footer = ({ onNavigate }) => {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/5 bg-[#050505] pb-8 pt-16 sm:pb-10 sm:pt-20">
      <div className="pointer-events-none absolute left-1/4 top-0 h-96 w-96 rounded-full bg-white/10 blur-[120px]" />
      <div className="pointer-events-none absolute bottom-0 right-1/4 h-96 w-96 rounded-full bg-white/10 blur-[120px]" />

      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 sm:mb-16 sm:gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-white to-white text-xl font-bold text-white shadow-lg shadow-white/20">
                S
              </div>
              <h2 className="text-2xl font-black tracking-tighter uppercase text-white">
                Study In <span className="bg-gradient-to-r from-white to-white bg-clip-text text-transparent">Bengaluru</span>
              </h2>
            </div>
              ...
              {navigationLinks.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="flex items-center group text-white/40 transition-colors hover:text-white"
                  >
          ...
          <div className="space-y-6">
            ...
            <a href="#" className="group inline-block transition-transform hover:-translate-y-1">
              <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-black p-3 pr-6 transition-colors group-hover:border-white/50">
                <img
            ...
            <div className="rounded-2xl border border-white/20 bg-gradient-to-r from-white/10 to-transparent p-4">
