      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-4xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#32104f] text-white shadow-[0_30px_80px_rgba(0,0,0,0.6)]"
          >
            ...
            <div className="relative p-5 sm:p-8">
              ...
              <form className="grid gap-4 md:grid-cols-2">
                ...
                <div className="md:col-span-2 mt-2 flex items-center justify-between gap-4">
                  <button
                    type="submit"
                    className="rounded-lg bg-[#7c3aed] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#8b5cf6]"
                  >
                    Submit
                  </button>
                  <button
